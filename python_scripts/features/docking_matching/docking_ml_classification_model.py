...
def train_model(df, features, feature_name=None, test_size=0.3, random_state=42):
    ...
    # Cross-validation with PR AUC (only on training data, excluding BGC)
...
def main():
    ...
    output_dir = "/groups/itay_mayrose/alongonda/desktop/mibig_validate/docking"
    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(output_dir, "docking_ml_classification_summary.csv")
    ...
    weights_file = os.path.join(output_dir, "docking_multi_feature_weights.csv")
