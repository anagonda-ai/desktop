...
def main():
    csv_file = '/groups/itay_mayrose/alongonda/plantcyc/all_organisms/merged_pathways.csv'
    output_file = '/groups/itay_mayrose/alongonda/plantcyc/all_organisms/pathway_gene_count.csv'
