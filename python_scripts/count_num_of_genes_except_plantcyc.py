...
def create_id_file_mapping(base_dir):
  ...
  for dirpath, _, filenames in os.walk(base_dir):
    ...
    # if "/groups/itay_mayrose/alongonda/desktop/plantcyc/plantcyc" not in dirpath:
...
if __name__ == "__main__":
    ...
    for key, item in id_file_mapping.items():
        if "/groups/itay_mayrose/alongonda/desktop/plantcyc/plantcyc/15.1.1/data/sequences_for_each_port_id.txt" in item:
