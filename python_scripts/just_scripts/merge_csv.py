...
def main():
    csv_dir = "/groups/itay_mayrose/alongonda/full_genomes/annotations/"
    output_csv_path = "/groups/itay_mayrose/alongonda/full_genomes/annotations/merged_annotations.csv"
