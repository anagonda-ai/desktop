...
df = pd.read_csv('/groups/itay_mayrose_nosnap/alongonda/desktop/single_protein_blast/arabidopsis_foldseek_calculations/aln_tmscore_final_folder/aln_tmscore_final_preprocesses.tsv', sep='\t', header=None)
...
filtered_df.to_csv(f'/groups/itay_mayrose_nosnap/alongonda/desktop/single_protein_blast/arabidopsis_foldseek_calculations/aln_tmscore_final_folder/filtered_tmscore_final_with_{treshold}_treshold.tsv', sep='\t', index=False, header=False)
