...
def main():
    blast_output_file = '/groups/itay_mayrose/alongonda/desktop/arabidopsis/arabidopsis_on_ensembl_phytozome_blastdb.txt'
    csv_output_file = '/groups/itay_mayrose/alongonda/desktop/arabidopsis/arabidopsis_on_ensembl_phytozome_blastdb.csv'
