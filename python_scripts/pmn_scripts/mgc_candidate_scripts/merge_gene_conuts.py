...
candidate_gene_count = pd.read_csv("/groups/itay_mayrose/alongonda/plantcyc/pmn_mgc_potential/mgc_candidates_process/candidate_gene_counts.csv")
...
merged_df.to_csv("/groups/itay_mayrose/alongonda/plantcyc/pmn_mgc_potential/mgc_candidates_process/candidate_gene_counts_with_pathway.csv", index=False)
print(merged_df)
