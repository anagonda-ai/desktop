...
def main():
    ...
    output_file_path = '/groups/itay_mayrose/alongonda/desktop/plantcyc/gene_by_db_seq/dblinks_for_uniqueids.txt'
    unique_dbs_file_path = '/groups/itay_mayrose/alongonda/desktop/plantcyc/gene_by_db_seq/unique_dbs_count.txt'
    unique_dbs_for_unique_id_file_path = '/groups/itay_mayrose/alongonda/desktop/plantcyc/gene_by_db_seq/unique_dbs_for_unique_id.txt'
