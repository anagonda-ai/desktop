...
csv_files = [
    '/groups/itay_mayrose_nosnap/alongonda/plantcyc/pmn_mgc_potential/plaza/plaza_genes.csv',
    '/groups/itay_mayrose_nosnap/alongonda/plantcyc/pmn_mgc_potential/ensembl/ensembl_genes.csv',
    '/groups/itay_mayrose_nosnap/alongonda/plantcyc/pmn_mgc_potential/phytozome/phytozome_genes.csv'
]

# Define the path to the DeepEC_Result.txt file
deep_ec_result_file = '/groups/itay_mayrose_nosnap/alongonda/plantcyc/pmn_mgc_potential/pmn.1732804635/log_files/3digit_EC_prediction.txt'
