...
deep_ec_result_file = '/groups/itay_mayrose/alongonda/plantcyc/pmn_mgc_potential/pmn.1732804635/log_files/3digit_EC_prediction.txt'
...
new_file_path = '/groups/itay_mayrose/alongonda/plantcyc/pmn_mgc_potential/mgc_candidates_process/combined_updated_genes.csv'
