...
# Lowercase 'Query ID' in both DataFrames before merging
combined_df['Query ID'] = combined_df['Query ID'].str.lower()
deep_ec_df['Query ID'] = deep_ec_df['Query ID'].str.lower()
