...
# Load the dataframes
df1 = pd.read_csv('/groups/itay_mayrose_nosnap/alongonda/Plant_MGC/unique_clusters_sliding_window_outputs/unique_potential_groups_with_window_size_10.csv')
df2 = pd.read_csv('/groups/itay_mayrose_nosnap/alongonda/Plant_MGC/unique_clusters_sliding_window_outputs_chromosome_sorted/unique_potential_groups_w10.csv')
