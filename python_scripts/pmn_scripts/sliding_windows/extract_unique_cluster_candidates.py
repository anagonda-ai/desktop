...
# Example usage
file_path = '/groups/itay_mayrose/alongonda/desktop/plantcyc/pmn_mgc_potential/potential_groups_with_window.csv'
...
# output_file_path = '/groups/itay_mayrose/alongonda/desktop/plantcyc/pmn_mgc_potential/unique_clusters.csv'
