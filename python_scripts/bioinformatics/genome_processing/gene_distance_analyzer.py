...
for mgc_id, distance in max_distances.items():
    print(f'Maximal distance between 3 neighboring genes in MGC {mgc_id}: {distance}bp')

print(f'Maximal distance between 3 neighboring genes is {max_distance_total}bp in cluster {max_distance_cluster}')
print(f'Average distance between 3 neighboring genes in MGC is {avg_distance}bp')
print(f'Median distance between 3 neighboring genes in MGC is {median_distance}bp')