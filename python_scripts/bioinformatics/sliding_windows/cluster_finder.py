...
def main():
    ...
    unfiltered_candidates_path = '/groups/itay_mayrose/alongonda/datasets/plantcyc/pmn_mgc_potential/mgc_candidates_process/unfiltered_candidates_for_pairwise.csv'
    output_path = '/groups/itay_mayrose/alongonda/datasets/plantcyc/pmn_mgc_potential/mgc_candidates_process/random_candidates.json'
