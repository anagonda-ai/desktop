...
directory = "/groups/itay_mayrose/alongonda/desktop/plantcyc/all_organisms/"
output_file = "/groups/itay_mayrose/alongonda/desktop/plantcyc/all_organisms_row_count.txt"
# Get the results
