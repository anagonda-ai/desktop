...
python AlphaPulldown/alphapulldown/scripts/create_individual_features.py --fasta_paths="/groups/itay_mayrose_nosnap/alongonda/desktop/Alphapulldown_TestRun/sequences.fasta" --data_dir=/groups/itay_mayrose_nosnap/alongonda/alphafold_database_script/ --output_dir="/groups/itay_mayrose_nosnap/alongonda/desktop/Alphapulldown_TestRun/output_dir/" --max_template_date=2050-01-01 --save_msa_files=False