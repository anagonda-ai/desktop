...
conda run -n base python /groups/itay_mayrose/alongonda/desktop/python_scripts/asaph_aharoni/single_multi_chromosome_cluster_statistics.py --example_mgc "$CLUSTRER"