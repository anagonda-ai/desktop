...
class NormalizerProcessor(BioinformaticsProcessor):
    """Migrated from legacy script: normalizer.py."""
...
# Main script
if len(sys.argv) != 2:
    logger.info("Usage: python normalize_blast_results.py <blast_csv_file>")
    sys.exit(1)
...
logger.info(f"Normalized BLAST results saved to {output_file}")