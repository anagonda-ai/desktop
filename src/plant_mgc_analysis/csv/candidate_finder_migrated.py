...
class CandidateFinderProcessor(BioinformaticsProcessor):
    """Migrated from legacy script: candidate_finder.py."""
...
logger.info(f"Filtered pathways have been written to {output_file}")
