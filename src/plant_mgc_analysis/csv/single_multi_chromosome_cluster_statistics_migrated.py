...
class SingleMultiChromosomeClusterStatisticsProcessor(BioinformaticsProcessor):
    """Migrated from legacy script: single_multi_chromosome_cluster_statistics.py."""
...
def plot_results(results, output_dir, chunk_size=50):
    ...
    logger.info(f"Plots saved in: {sub_dir}")
