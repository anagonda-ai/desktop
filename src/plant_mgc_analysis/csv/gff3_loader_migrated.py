...
class Gff3LoaderProcessor(BioinformaticsProcessor):
    """Migrated from legacy script: gff3_loader.py."""
...
def process_file(file_path, output_directory):
    ...
    logger.info(f"Transformed and saved {file_path} to {transformed_output_file_path}")
...
def main():
    ...
    for df in dataframes:
        ...
        logger.info(df.head())  # Print the first few rows of each DataFrame
