...
class VisualizeTimetreeProcessor(BioinformaticsProcessor):
    """Migrated from legacy script: visualize_timetree.py."""
...
def get_taxid(species):
    ...
    try:
        ...
        logger.info(f"❌ Error fetching TaxID for {species}: {e}")
    return None
