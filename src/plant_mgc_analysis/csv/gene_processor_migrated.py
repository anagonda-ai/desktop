...
class GeneProcessor(BioinformaticsProcessor):
    """Migrated from legacy script: gene_processor.py."""
...
def find_gene_positions(pathways_dict, gene_dict):
    ...
    for unique_id, gene_ids in pathways_dict.items():
        ...
        for gene_id in gene_ids:
            ...
            if gene_id in gene_dict:
                ...
                logger.info(f"Pathway: {unique_id}, Gene: {gene_id}, Transcripts: {transcripts}")
                ...
                logger.info(f"Pathway: {unique_id}, Gene: {gene_id} not found in dictionary")
    ...
    new_dir = "/groups/itay_mayrose/alongonda/datasets/full_genomes/annotations/test_dir/pmn_genomes"
    ...
    logger.info(f"Number of genes not found: {not_found}")

def main():
    gene_files = ["/groups/itay_mayrose/alongonda/datasets/full_genomes/annotations/test_dir/merged_annotations.csv"]
